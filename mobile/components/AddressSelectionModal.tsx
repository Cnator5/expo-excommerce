...
const AddressSelectionModal = ({
  ...
  // Logic to select the default address automatically
  useEffect(() => {
  ...
  return (
    <Modal visible={visible} animationType="slide" transparent={true} onRequestClose={onClose}>
      <View className="flex-1 bg-black/100 justify-end">
        <View className="bg-background rounded-t-3xl h-1/2">
          {/* Modal Header */}
          <View className="flex-row items-center justify-between p-20 border-b border-surface">
            <Text className="text-text-primary text-2xl font-bold">Select Address</Text>
            <TouchableOpacity onPress={onClose} className="bg-surface rounded-full p-2">
              <Ionicons name="close" size={24} color="#FFFFFF" />
            </TouchableOpacity>
                    ...
                    <View className="flex-row items-start justify-between">
                      ...
                      <View 
                        style={{ 
                          ...
                          borderRadius: 14, 
                          borderWidth: 2, 
                          borderColor: selectedAddress?._id === address._id ? '#1DB954' : '#FFFFFF',
                          backgroundColor: selectedAddress?._id === address._id ? '#1DB954' : 'transparent',
                          alignItems: 'center',
